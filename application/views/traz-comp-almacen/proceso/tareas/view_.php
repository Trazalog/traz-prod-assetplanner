...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <?php echo (isset($estadoOT) && $estado==false?'<h4 class="text-danger text-center">La Orden de Trabajo Asociada al Pedido de Materiales fue Cancelada</h4><h5 class="text-center">No se podran realizar mas Entregas</h5>':null) ?>  
