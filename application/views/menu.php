...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        echo $this->multi_menu->inject_item('<li><a href="#" onClick="linkTo(\'' . SIM . 'Form/formCalidad\')" data-permission="View-"><i class="fa fa-edit"></i><span>Formulario de Calidad</span></a></li>'.'<li><a href="http://localhost/traz-prod-assetplanner/Mapa" class="link" data-link="Mapas" data-permission="View-"><i class="fa fa-map"></i>Test Mapa</a></li>')
            ->render();
