...
<section class="content">
	...
	<?php //dump($TareaBPM); ?>
	<input type="text" class="form-control hidden" id="id_OT" value="<?php echo $id_OT ?>">
	<input type="text" class="form-control hidden" id="id_SS" value="<?php echo $id_SS ?>">
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
									...
									<div class="tab-content">
										...
										<div class="form-group" id="decisionSolicitud">
											<div class="radioBtn col-sm-12 col-md-12">
												<center>
													<label class="control-label">¿Esta conforme con el Trabajo?
													</label>
													</br>
													<div class="col-md-12">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-success" id="hecho" onclick="prestarConformidad()">Hecho</button>
				</div> <!-- /.modal footer -->
