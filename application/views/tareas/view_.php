...
<section class="content">
	...
	// echo '<td><i class="fa fa-paperclip text-light-blue  getFormularioTarea" style="cursor: pointer; margin-left: 15px;" aria-hidden="true" data-open="false" data-validado="false" data-formid="'.$subt["form_asoc"].'" data-idformsub="'.$subt["form_asoc"].'"></i></td>';
	...
	echo '</tr>';
					...
					<div class="row">
						<div class="col-sm-12 col-md-12">
								<button type="button" id="pedidoInsumos" class="btn btn-primary" onclick="verOT()">Ver Orden Trabajo</button>
						</div>
					</div>	</br>											
