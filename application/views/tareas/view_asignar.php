								...
								<div class="form-group">
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li
											...
											<a href="#vista_global" aria-controls="vista_global" role="tab"
...
function asignarTareas() {
	var iort = $('#idOt').val();
	sessionStorage.setItem('task_id',$('#idTarBonita').val());
	sessionStorage.setItem('case_id',$('#case_id').val());
	WaitingOpen();
	$('#content').empty();
	$("#content").load("<?php echo base_url(); ?>index.php/Otrabajo/listOrden/<?php echo str_replace("Add","",$permission."-Asignar")?>/"+ iort);
	WaitingClose();
}
</script>
