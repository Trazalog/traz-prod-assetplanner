                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4">
                        ...
                        <input type="text" class="form-control codherram" id="codherram" value="" placeholder="">
                        <input type="hidden" name="herrId" class="form-control herrId" id="herrId" value="" placeholder="" >
                      </div>
                    </div><br>
