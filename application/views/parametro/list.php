              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      <label for="parametro">Parametro <strong style="color: #dd4b39">*</strong>:</label>
...
function traer_equipo(){
  $.ajax({
    type: 'POST',
    data: { },
    url: 'index.php/Parametro/getequipo',
    success: function(data){
...
function traer_parametro(){
  ...
  $.ajax({
    type: 'POST',
    data: {},
    url: 'index.php/Parametro/traerparametro', 
    success: function(data){
...
function guardar(){ 
  ...
  $.ajax({
    type: 'POST',
    data: {data:parametros},
    url: 'index.php/Parametro/guardar', 
    success: function(data){
      console.log("exito");
      console.log(data);
      $('#descripcion1').val("");
