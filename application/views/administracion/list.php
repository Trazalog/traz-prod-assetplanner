                      ...
                      echo '<tr id="'.$id.'" class="'.$id.'">';
                        echo '<td>'; 
                          if (strpos($permission,'Add') !== false) { //Entregar
                            echo '<i class="fa fa-sticky-note text-light-blue" style="cursor: pointer; margin-left: 15px;"  title="ver Orden de Perdido " ></i>';
                            echo '<i class="fa fa-clone text-light-blue" style="cursor: pointer; margin-left: 15px;" title="Ver Nota Pedido" data-toggle="modal" data-target="#modallista"></i>'; 
                          }                            
      	                echo '</td>';
                        echo '<td>'.$a['nro'].'</td>';
      	                echo '<td>'.$a['fecha_inicio'].'</td>';
                        echo '<td>'.$a['fecha_entrega'].'</td>';
                        echo '<td>'.$a['fecha_terminada'].'</td>';
