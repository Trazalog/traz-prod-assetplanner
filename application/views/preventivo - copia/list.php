  ...
  $(".fa-pencil").click(function (e) { 
            ...
            $.ajax({
              ...
              success: function(data){
                      ...
                      //console.log("periodo: " + data['datos'][0]['perido']);
...
function guardar(){
    ...
    var date = new Date(ultimo);
    var dia = date.getDate();
    var mes = date.getMonth();
    var ano = date.getFullYear();
    ult_fecha = ano + '-' + mes + '-' + dia;

    console.log('fecha ultimo' + ult_fecha);



    var parametros = {'id_equipo': id_equipo,
                      'id_tarea': tarea,
                      'perido': periodo,
                      'cantidad': cantidad,
                      'ultimo' : ult_fecha,
                  ...
                  <h3 class="panel-title fa fa-cogs">  Datos del Equipo </h3>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-4">Equipos <strong style="color: #dd4b39">*</strong>
                           ...
                           <input  id="equipo" name="componente" class="form-control" value="" disabled></input>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">  
                              ...
                              <div class="col-xs-4">Periodo <strong style="color: #dd4b39">*</strong>:
                                ...
                                <input type="text" id="periodo"  name="periodo" class="form-control input-md"/>
                              </div>
