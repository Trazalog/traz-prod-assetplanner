...
function guardarSector(){
  ...
  $.ajax({
    ...
    url: 'index.php/Sector/Guardar_Sector', 
...
function editarSector(){
  ...
  var hayError    = false;
  if($('#descripcionE').val() == '' || $('#id_empresaE').val() == '' || $('#estadoE').val() == '' )
  {
    hayError = true;
  }
  if(hayError == true){
  ...
  $.ajax({
    type: 'POST',
    dataType : "json",
    data: {"id_sector" : id,  "descripcion":descripcion,  "id_empresa":id_empresa,  "estado":estado },
    url: 'index.php/Sector/Modificar_Sector', 
    success: function(result){
      WaitingClose();
...
function eliminarSector(){
  ...
  $.ajax({
    type: 'POST',
    data: { "id_sector": id_},
    url: 'index.php/Sector/Eliminar_Sector', 
...
function ActualizarPagina(){ //Funcion Resfresca
  $('#content').empty();
  $("#content").load("<?php echo base_url(); ?>index.php/Sector/index/<?php echo $permission; ?>");
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="guardarSector()" >Guardar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal --><!-- Modal -->
...
<div class="modal" id="modalEditar">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-primary" onclick="editarSector()" >Guardar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal --><!-- Modal -->
...
<div class="modal" id="modalEliminar">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="eliminarSector()" >Eliminar</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
