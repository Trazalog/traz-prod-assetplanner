                  ...
                  <div class="panel-body">
                   ...
                   <!-- <hr>
                     ...
                     <div class="row" > -->
                      ...
                      <!-- <div class="col-xs-12 col-sm-8"><label>Seleccione Plantilla de Insumos</label> <strong style="color: #dd4b39">*</strong> :   
...
//llena tabla con tareas de la plantilla
$('#plantilla').change(
		function(){
            ...
            success: function(data){ 
                            ...
                            for(i = 0; i < data.length; i++) {
                              ...
                              var artDescrip			= data[i]['artDescription'];
                              var id = data[i]['artId'];
                              ...
                              tablaCompleta = tabla.row.add( [																												
                                ...
                                // 	artDescrip
                                  ...
                                  '<input type="text" class="celda insum_Desc" id="insum_Desc" value=" '+ artDescrip +' " placeholder=""><input type="hidden" name="insum_Id'+ '['+ regInsum+']' +'" class="celda insum_Id" id="insum_Id" value=" '+ id +' " placeholder="">',
                                  
                                  '<input type="text" name="cant_insumos'+ '['+ regInsum+']' +'" class="celda cant_insumos" id="cant_insumos" value="0" placeholder="">'
