  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
          <table id="proceso" class="table table-bordered table-hover">
            <thead>
              <tr>
            ...
            <tbody>
              <?php
                foreach($list as $f)
                {
                  ...
                  echo '</td>';
                  echo '<td style="text-align: left">'.$f['id_proceso'].'</td>';
...
>function guardarproceso(){
    ...
    $('#error').fadeOut('slow');          $.ajax({
             ...
             url: 'index.php/proceso/Guardar_proceso', 
    ...
    $('#errorE').fadeOut('slow');
     $.ajax({
       type: 'POST',
       dataType : "json",
       data: {"id_proceso" : id,  "descripcion":descripcion,  "id_empresa":id_empresa },
       url: 'index.php/proceso/Modificar_proceso', 
       success: function(result){
        WaitingClose();
  ...
  function eliminarproceso(){
    ...
    $.ajax({
      type: 'POST',
      data: { "id_proceso": id_},
      url: 'index.php/proceso/Eliminar_proceso', 
  ...
  $('#content').empty();
  $("#content").load("<?php echo base_url(); ?>index.php/proceso/index/<?php echo $permission; ?>");
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="eliminarproceso()" >Eliminar</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
