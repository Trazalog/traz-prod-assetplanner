...
<section class="content">
  ...
  <div class="col-xs-12 col-lg-6">
    <div class="box box-primary">
      <div class="box-body">
        <div class="fa fa-fw fa-print text-light-blue" style="cursor: pointer; margin-left: 15px; border-radius: 18px;" title="Imprimir"></div>
        <div id="calendar"></div>
      </div><!-- /.box-body -->
    </div><!-- /. box -->
  </div><!-- /.col --> 
...
function updateHora(id_OT, duracion) {
  var resultad = $.ajax({
    data: { id:id_OT, duracion:duracion }, // duracion adicional
    dataType: 'json',
    type: 'POST', 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-xs-12 col-sm-6">Tipo de Evento
          <select class="form-control input-md" id="event_Preventivo">
            <option value="1">Unico</option>
            <option value="2">Mensual</option>
          </select>
        </div>
        <div class="col-xs-12 col-sm-6">Cantidad Meses 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-xs-12 col-sm-4">Hora:
