...
function guardarCliente() {
    ...
    var hayError = false;
    if ($('#cliName').val() == '' || $('#cliDni').val() == '' || $('#cliAddress').val() == '' || $('#cliPhone').val() ==
        '' || $('#cliEmail').val() == '' || $('#cliRazonSocial').val() == '') {
        hayError = true;
    }
    if (hayError == true) {
        $('#error').fadeIn('slow');
...
function editarCliente() {
    ...
    var hayError = false;
    if ($('#cliNameE').val() == '' || $('#cliDniE').val() == '' || $('#cliAddressE').val() == '' || $('#cliPhoneE')
        .val() == '' || $('#cliEmailE').val() == '' || $('#cliRazonSocialE').val() == '') {
        hayError = true;
    }
    if (hayError == true) {
        $('#errorE').fadeIn('slow');
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal"
                    onclick="eliminarCliente()">Eliminar</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
