    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Criticidades</h3>
          <?php
        ...
        <div class="box-body">
          <table id="criticidad" class="table table-bordered table-hover">
            <thead>
              <tr>
            ...
            <tbody>
              <?php
                foreach($list as $f)
                {
                  ...
                  echo '</td>';
                  echo '<td style="text-align: left">'.$f['id_criti'].'</td>';
...
function guardarcriticidad(){
      ...
      var hayError = false;
        ...
        $.ajax({
             ...
             url: 'index.php/criticidad/Guardar_criticidad', 
    ...
    $('#errorE').fadeOut('slow');
     $.ajax({
       type: 'POST',
       dataType : "json",
       data: {"id_criti" : id,  "descripcion":descripcion,  "id_empresa":id_empresa },
       url: 'index.php/criticidad/Modificar_criticidad', 
       success: function(result){
        WaitingClose();
  ...
  function eliminarcriticidad(){

    $.ajax({
      type: 'POST',
      data: { "id_criti": id_},
      url: 'index.php/criticidad/Eliminar_criticidad', 
  ...
  $('#content').empty();
  $("#content").load("<?php echo base_url(); ?>index.php/criticidad/index/<?php echo $permission; ?>");

}$(function () {
      
      $('#criticidad').DataTable({
          "paging": true,
          "lengthChange": true,
          "searching": true,
          "ordering": true,
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Agregar Criticidad</h4>
      </div>
...
<div class="modal" id="modalEditar">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">Editar Criticidad</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="editarcriticidad()" >Guardar</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
...
<div class="modal" id="modalEliminar">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">Eliminar Criticidad</h4>
      </div>
      <div class="modal-body" id="cuerpoModalEditar">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="eliminarcriticidad()" >Eliminar</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
