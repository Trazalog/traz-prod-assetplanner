...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-05-2019 a las 14:40:32
...
(2, 2, 'tarea forrra', '', NULL, 0, 0, NULL),
(3, 3, 'tareasssss', '', NULL, 0, 0, NULL);
...
(3, NULL, '2019-05-06', '', 3, 0, 1, 1, 'C', NULL, NULL, 1, 6, '2019-05-06 12:58:52', '2019-05-08 12:58:54', 123, 456);
...
(1, -1, '1', '2019-05-06', '2019-05-01 12:00:00', '2019-05-06 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'fala test', 1, 'As', 3, 3, 1, 1, 0, 1, '4', 3, 90, 1, 6, 0, 0, 14004);
...
(1, 2, '', '2019-05-03', '4', 2, 6, 'C', 3, 2, 2, 6, NULL);
...
(1, 5, 0, '4', 2, '2019-05-03', -1, NULL, NULL, 4, 'C', 2, 2, 2, NULL, 6, NULL);
...
(1, NULL, NULL, NULL, 'Gallardo, Hugo', '2019-05-06 11:02:42', '2019-05-07', '08:00:00', 3, NULL, 'fala test', NULL, 'C', 4, '0000-00-00', '', NULL, NULL, NULL, 'assets/files/orders/sinImagen.jpg', 6, 14004, NULL);
...
(1, 3, -1, '2019-05-06', NULL, 'C', 90, NULL, 0, 6, 0, NULL, 1, 'fala test');
...
--
ALTER TABLE `componenteequipo`
  MODIFY `idcomponenteequipo` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `predictivo`
  MODIFY `predId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `preventivo`
--
ALTER TABLE `preventivo`
  MODIFY `prevId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_valesalida`
  MODIFY `valesid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
