-- ---------------------------------------------------
-- MODIFICACIONES PARA LLEVAR A V 221
-- ----------------------------------------------------
-- 
...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2019 a las 11:31:43
...
--
-- Base de datos: `planner_assetcloud_almacen`
--
...
-- scripts/_INTEGRACION SIM - ASSETPLANNER/Version prueba general (vacia)/cambio campo estado en  alm_depositos_.txt
...
-- scripts/_INTEGRACION SIM - ASSETPLANNER/Version prueba general (vacia)/localidades-provincias.sql
...
-- TABLAS ALMACENES
-- scripts/almacenes/asset_almacen_18-06-2019.sql
...
CREATE TABLE `alm_pedidos_extraordinario` (
  ...
  `motivo_rechazo` varchar(200) COLLATE utf8_spanish_ci DEFAULT NULL,
...
CREATE TABLE `alm_recepcion_materiales` (
  ...
  `comprobante` varchar(255) CHARACTER SET utf8 NOT NULL,
  `empr_id` int(11) NOT NULL,
  `prov_id` int(10) NOT NULL,
  `fec_alta` datetime DEFAULT CURRENT_TIMESTAMP,
  `eliminado` tinyint(4) DEFAULT '0'
...
-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/Drop tabla articles.sql

DROP TABLE articles;

-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/Vista Articulos.sql
CREATE 
VIEW `articles`AS 
SELECT
...
-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/orden_trabajo id_usuario_a modif a NULL.sql

ALTER TABLE  orden_trabajo MODIFY id_usuario_a INT(11) NULL;

-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/tbl_back datetime en campo fecha.sql

ALTER TABLE  tbl_back MODIFY fecha DATETIME;

--  scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/tbl_inidadmedida id_unidadmedida Autoincrmentable.sql
-- se elimino esta linea en los commits


-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/Drop tabla abmproveedores.sql

DROP TABLE abmproveedores;

-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/Vista Proveedores.sql
...
-- scripts/cambiar_url_entrega_materiales.sql
UPDATE `sismenu` SET `slug` = 'almacen/new/Entrega_Material/index' WHERE (`id` = '20');


-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/Drop tabla abmdeposito.sql

DROP table abmdeposito;


-- scripts/almacen_ columna_dni.sql



-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/Vista Depositos.sql
...
-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/Agregar estado Planificado a TBL_ESTADOS.sql
INSERT tbl_estado SET descripcion = 'PLANIFICADO', estado = 'PL';


-- scripts/_INTEGRACION SIM - ASSETPLANNER/Articulos integracion/cambio longitud estado en Otrabajo.sql
...
UPDATE sismenu set name = 'Art�culos', slug = 'almacen/Articulo/index' where id=17;
UPDATE sismenu set slug = 'almacen/Lote/index' where id=18;
UPDATE sismenu set name = 'Entrega Materiales', slug = 'almacen/new/Entrega_Material/index' where id=20;
UPDATE sismenu set name = 'Recepci�n Materiales', slug = 'almacen/Remito/index' where id=21;
UPDATE sismenu set name = 'Punto Pedido', slug = 'almacen/Lote/puntoPedList' where id=28;
UPDATE sismenu set name = 'Pedido Materiales', slug = 'almacen/Notapedido/index' where id=43;
