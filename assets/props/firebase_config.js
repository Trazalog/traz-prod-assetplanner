...
//una vez obtenido el token lo guardo por usuario
function registraToken(currentToken){
    $.ajax({
        ...
        // processData: false,
        dataType: "json",
        url: 'index.php/Notificacion/registraToken',
        success: function(data) { 
           if(data)
           {
            console.log('guarde el token del usuario');
           }
           else{
            console.log('update estado o token del usuario');
           }
